  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        {user.isWorker ? (
          <>
            {/* Registered workers take jobs from Worker mode (go online, offers). */}
            <Pressable
            ...
            >
              ...
              <View style={styles.workCardText}>
                <Text style={styles.workCardTitle}>{t('workerMode.title')}</Text>
                <Text style={styles.workCardBody}>{t('workerMode.subtitle')}</Text>
              </View>
