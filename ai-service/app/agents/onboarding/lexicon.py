...
# Asking to change something ("yes, but change the income").
CHANGE = _norm_map(
    {
        "en": ["change", "edit", "update", "modify", "badal", "badalna", "badlo"],
        "hi": ["बदल", "बदलना", "बदलें", "बदलो", "बदलिए", "बदलनी", "बदलना है"],
        "mr": ["बदल", "बदला", "बदलायचे", "बदलायचं", "बदलायची"],
        "bn": ["বদল", "বদলান", "বদলাতে", "পরিবর্তন"],
        "ta": ["மாற்ற", "மாற்று", "மாற்றம்", "மாற்றணும்"],
        "te": ["మార్చు", "మార్చాలి", "మార్పు", "మార్చండి"],
    }
)
